        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-300">
            <div className=" bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 p-6">
                <div className="flex flex-col items-center pb-10">
                    <img className="mb-3 w-24 h-24 rounded-full shadow-lg" src='https://api-prod-minimal-v510.vercel.app/assets/images/avatar/avatar_25.jpg' alt="Foto de perfil" />
                    <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{user.nombre}</h5>
                    <span className="text-sm text-gray-500 dark:text-gray-400">{user.email}</span>
                    <span className="text-sm font-semibold text-gray-500 dark:text-gray-400">{user.rol.toUpperCase()}</span>
                    <span className="text-sm text-gray-500 dark:text-gray-400">{user.celular}</span>
                </div>
                ...
                <footer className="bg-white dark:bg-gray-900">
                    <div className="mx-auto w-full max-w-screen-xl">
                        ...
                        <div className="px-4 py-1  dark:bg-gray-700 md:flex md:items-center md:justify-between">
                            ...
                            <div className="flex mt-2 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
