...
export default function Aside() {
    ...
    return (
      <aside
        id="logo-sidebar"
        className={`fixed  top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0  bg-white border-r border-gray-100  dark:bg-gray-800 dark:border-gray-700 `}
        aria-label="Sidebar"
      >
