            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="https://flowbite.com" className="flex ms-2 md:me-24 items-center">
                            <img src="https://multilaptops.net/recursos/imagenes/favicon/ml_favicon2.png" className="h-8 me-3" alt="FlowBite Logo" />
                            <h1 className=" hidden sm:block text-2xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-3xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-[#6C2BD9] from-sky-200">Store</span> </h1>
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center ms-3">
                            ...
                            <div>
                                <h1 className='text-3xl w-10 h-10 rounded-full border flex items-center text-center p-1 mx-2 bg-[#FDF2F2] hover:bg-[#F8B4B4]'>
                                    <CiSettings />
                                </h1>
