        ...
        <div className="">
            ...
            <div
                className={`transform transition-transform z-50  ${menuVisible ? "translate-x-0" : "-translate-x-full"
                    } w-64 bg-gray-900  p-4 fixed inset-y-0 left-0 text-white overflow-y-auto scrollbar scrollbar-thumb-rounded-full scrollbar-thumb-gray-600 scrollbar-track-gray-100`}
            >
                {/* Contenido del menú */}
                <Buscar2 />
                {/* Lista de marcas */}
