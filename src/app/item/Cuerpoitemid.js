            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full px-4 md:px-10 lg:px-20">
                <div className="flex flex-col justify-center p-6  h-full">
                    ...
                    {/* <div className="grid grid-cols-4 gap-4">
                        {Object.values(producto.imagenes).slice(0, 4).map((row, index) => (
                            <div className="border overflow-hidden h-[80px]">
                                <img
                    ...
                    //             }}
                    //         >
                    //             {Object.values(producto.imagenes).slice(0, 5).map((row, index) => (
                    //                 <SplideSlide
                    //                     key={index}
                    //                     onClick={() => 
